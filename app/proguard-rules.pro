...
-keepclassmembers class com.zenlemon.data.remote.** { <fields>; }
...
-keep class com.zenlemon.domain.model.** { *; }
-keep class com.zenlemon.data.local.entity.** { *; }
-keep class com.zenlemon.data.remote.xtream.model.** { *; }

# ── Security / TLS ──────────────────────────────────────────
-keepnames class com.zenlemon.data.security.CredentialCrypto
-keepclassmembers class com.zenlemon.data.security.CredentialCrypto {
    <fields>;
    <methods>;
}
