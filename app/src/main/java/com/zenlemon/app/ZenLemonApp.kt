...
import com.zenlemon.data.remote.jellyfin.JellyfinImageAuthInterceptor
...
import com.zenlemon.data.manager.recording.RecordingReconcileWorker
import com.zenlemon.data.sync.ProviderSyncWorker
import com.zenlemon.data.sync.XtreamIndexWorker
import com.zenlemon.player.timeshift.TimeshiftDiskManager
import javax.inject.Inject
import okhttp3.OkHttpClient

@HiltAndroidApp
class ZenLemonApp : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        val gcWorkRequest = PeriodicWorkRequestBuilder<com.zenlemon.data.sync.SyncWorker>(24, java.util.concurrent.TimeUnit.HOURS)
