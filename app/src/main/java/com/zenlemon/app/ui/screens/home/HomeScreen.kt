...
import com.zenlemon.app.ui.components.LiveSourceSwitcher
import com.zenlemon.app.ui.components.shell.ContentMetadataStrip
import com.zenlemon.app.ui.components.shell.LiveChannelRowSurface
...
import com.zenlemon.app.ui.components.dialogs.HiddenCategoriesDialog
import com.zenlemon.app.ui.components.dialogs.HiddenChannelsDialog
...
import com.zenlemon.app.ui.remote.LiveBrowseRemoteShortcutHandler
import com.zenlemon.app.ui.remote.dispatchLiveBrowseRemoteShortcut
import com.zenlemon.app.ui.remote.remoteColorButtonForKeyCode
                            ...
                            val handler = when (val target = focusedRemoteShortcutTarget) {
                                ...
                                is FocusedRemoteShortcutTarget.CategoryTarget -> {
                                    ...
                                    if (isLockedCategory && action in setOf(
                                            com.zenlemon.domain.model.RemoteShortcutAction.PIN_CATEGORY,
                                            com.zenlemon.domain.model.RemoteShortcutAction.HIDE_CATEGORY
                                        )
                                    ) {
                                        null
                                    } else {
