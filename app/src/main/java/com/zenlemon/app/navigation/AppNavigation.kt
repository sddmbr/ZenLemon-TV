...
import com.zenlemon.app.ui.screens.movies.MoviesScreen
import com.zenlemon.app.ui.screens.player.PlayerScreen
import com.zenlemon.app.ui.screens.plugins.PluginsScreen
import com.zenlemon.app.ui.screens.provider.ProviderSetupScreen
import com.zenlemon.app.ui.screens.series.SeriesScreen
...
fun AppNavigation(mainActivity: MainActivity) {
    ...
    NavHost(
        ...
        composable(
            ...
            com.zenlemon.app.ui.screens.epg.FullEpgScreen(
        ...
        composable(
            ...
            com.zenlemon.app.ui.screens.settings.parental.ParentalControlGroupScreen(
                currentRoute = Routes.SETTINGS,
                onNavigate = { route -> tabNavigate(route) },
                onBack = { navController.popBackStack() }
            )
        ...
        composable(
            ...
            com.zenlemon.app.ui.screens.search.SearchScreen(
        ...
        composable(
            ...
            com.zenlemon.app.ui.screens.movies.MovieDetailScreen(
                onPlay = { movie ->
                    navController.navigateToPlayer(
        ...
        composable(
            ...
            com.zenlemon.app.ui.screens.series.SeriesDetailScreen(
