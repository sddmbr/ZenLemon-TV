...
@AndroidEntryPoint
class ZenLemonTvInputService : TvInputService() {
    ...
    override fun onCreateSession(inputId: String): Session = ZenLemonSession(this)

    private inner class ZenLemonSession(context: Context) : Session(context) {
    ...
    private companion object {
        const val TAG = "ZenLemonTvInput"
        const val DEFAULT_USER_AGENT = "ZenLemonTvInput"
