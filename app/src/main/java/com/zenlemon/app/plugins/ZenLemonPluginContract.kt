...
object ZenLemonPluginContract {
    const val API_VERSION = 1

    const val ACTION_PLUGIN_SERVICE = "com.zenlemon.plugin.API"
    const val META_MANIFEST_JSON = "com.zenlemon.plugin.MANIFEST_JSON"
    const val META_ID = "com.zenlemon.plugin.ID"
    const val META_NAME = "com.zenlemon.plugin.NAME"
    const val META_VERSION_NAME = "com.zenlemon.plugin.VERSION_NAME"
    const val META_VERSION_CODE = "com.zenlemon.plugin.VERSION_CODE"
    const val META_DESCRIPTION = "com.zenlemon.plugin.DESCRIPTION"
    const val META_CAPABILITIES = "com.zenlemon.plugin.CAPABILITIES"
    const val META_CONFIGURATION_MODE = "com.zenlemon.plugin.CONFIGURATION_MODE"
    const val META_CONFIGURATION_ACTIVITY_ACTION = "com.zenlemon.plugin.CONFIGURATION_ACTIVITY_ACTION"
    const val META_PROVIDER_NAME = "com.zenlemon.plugin.PROVIDER_NAME"
