...
data class BackupData(
    ...
    val favorites: List<com.zenlemon.domain.model.Favorite>? = null,
    val virtualGroups: List<com.zenlemon.domain.model.VirtualGroup>? = null,
...
interface BackupManager {
     ...
     */
    suspend fun exportConfig(uriString: String): com.zenlemon.domain.model.Result<Unit>
