...
import com.zenlemon.data.local.dao.PlaybackCompatibilityDao
import com.zenlemon.data.local.entity.PlaybackCompatibilityRecordEntity
...
class PlaybackCompatibilityRepositoryImplTest {
    ...
    private fun readDaoSource(): String {
        val candidates = listOf(
            Paths.get("src", "main", "java", "com", "zenlemon", "data", "local", "dao", "Daos.kt"),
            Paths.get("data", "src", "main", "java", "com", "zenlemon", "data", "local", "dao", "Daos.kt")
        )
