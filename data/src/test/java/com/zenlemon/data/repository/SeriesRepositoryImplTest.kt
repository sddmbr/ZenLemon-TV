...
import com.zenlemon.data.local.entity.EpisodeBrowseEntity
import com.zenlemon.data.local.entity.EpisodeEntity
import com.zenlemon.data.local.entity.SeriesEntity
import com.zenlemon.data.local.entity.SeriesBrowseEntity
...
import com.zenlemon.data.remote.dto.XtreamSeason
import com.zenlemon.data.remote.dto.XtreamSeriesInfoResponse
import com.zenlemon.data.remote.stalker.StalkerCategoryRecord
import com.zenlemon.data.remote.stalker.StalkerEpisodeRecord
...
import com.zenlemon.data.remote.stalker.StalkerSeasonRecord
import com.zenlemon.data.remote.stalker.StalkerSeriesDetails
...
import com.zenlemon.domain.model.VodDuplicateConfidence
import com.zenlemon.domain.model.VodDuplicateHandlingMode
import com.zenlemon.domain.model.VodSeriesVariant
import com.zenlemon.domain.model.VodVariantObservation
...
class SeriesRepositoryImplTest {
    ...
    fun `stalker series preview loads only first page`() = runTest {
        ...
        whenever(categoryDao.getByProviderAndType(7L, ContentType.SERIES.name)).thenReturn(
            flowOf(listOf(com.zenlemon.data.local.entity.CategoryEntity(providerId = 7L, categoryId = 77L, name = "Drama", type = ContentType.SERIES)))
        )
        whenever(providerDao.getById(7L)).thenReturn(
            ProviderEntity(
                id = 7L,
    ...
    fun `getSeriesDetails falls back to remote series id lookup`() = runTest {
        ...
        assertThat(result).isInstanceOf(com.zenlemon.domain.model.Result.Success::class.java)
        val series = (result as com.zenlemon.domain.model.Result.Success).data
