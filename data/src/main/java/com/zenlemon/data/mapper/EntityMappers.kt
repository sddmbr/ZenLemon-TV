package com.zenlemon.data.mapper

import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.zenlemon.data.local.entity.*
import com.zenlemon.data.remote.stalker.StalkerPlaybackDescriptor
...
import com.zenlemon.domain.model.*
...
fun CategoryEntity.toDomain() = com.zenlemon.domain.model.Category(
    id = categoryId,
    roomId = id,
    name = name,
    parentId = parentId,
...
fun com.zenlemon.domain.model.Category.toEntity(providerId: Long) = CategoryEntity(
    categoryId = id,
    name = name,
    parentId = parentId,
    type = type,
...
fun SyncMetadataEntity.toDomain() = SyncMetadata(
    ...
    movieSyncMode = runCatching { com.zenlemon.domain.model.VodSyncMode.valueOf(movieSyncMode) }
        .getOrDefault(com.zenlemon.domain.model.VodSyncMode.UNKNOWN),
...
fun EpgSourceEntity.toDomain() = com.zenlemon.domain.model.EpgSource(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.zenlemon.domain.model.EpgSource.toEntity() = EpgSourceEntity(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.zenlemon.data.local.dao.ProviderEpgSourceWithDetails.toDomain() =
    com.zenlemon.domain.model.ProviderEpgSourceAssignment(
        id = id,
        providerId = providerId,
...
fun com.zenlemon.domain.model.ProviderEpgSourceAssignment.toEntity() = ProviderEpgSourceEntity(
    id = id,
    providerId = providerId,
    epgSourceId = epgSourceId,
    priority = priority,
...
fun EpgChannelEntity.toDomain() = com.zenlemon.domain.model.EpgChannelInfo(
    id = id,
    epgSourceId = epgSourceId,
...
fun ChannelEpgMappingEntity.toDomain() = com.zenlemon.domain.model.ChannelEpgMapping(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
    sourceType = runCatching { com.zenlemon.domain.model.EpgSourceType.valueOf(sourceType) }
        .getOrDefault(com.zenlemon.domain.model.EpgSourceType.NONE),
    epgSourceId = epgSourceId,
    xmltvChannelId = xmltvChannelId,
    matchType = matchType?.let {
        runCatching { com.zenlemon.domain.model.EpgMatchType.valueOf(it) }.getOrNull()
    },
...
fun com.zenlemon.domain.model.ChannelEpgMapping.toEntity() = ChannelEpgMappingEntity(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
