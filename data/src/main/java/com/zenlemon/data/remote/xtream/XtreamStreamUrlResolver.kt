...
import com.zenlemon.data.remote.jellyfin.buildJellyfinAuthorizationHeader
...
import com.zenlemon.data.remote.stalker.buildStalkerPlaybackDescriptor
...
class XtreamStreamUrlResolver @Inject constructor(
        ...
        return when (resolvedProvider.type) {
            ...
            ProviderType.STALKER_PORTAL -> {
                ...
                val playbackInfo = when (
                    ...
                    is com.zenlemon.domain.model.Result.Success -> resolvedResult.data
                    is com.zenlemon.domain.model.Result.Error -> throw StalkerPlaybackResolutionException(
    ...
    private suspend fun resolveDirectStalkerUrl(
        ...
        val descriptor = buildStalkerPlaybackDescriptor(
            ...
            capabilities = com.zenlemon.data.remote.stalker.StalkerPortalCapabilities()
        )
    ...
    private suspend fun persistStalkerPlaybackLearning(
        provider: ProviderEntity,
        playbackInfo: com.zenlemon.data.remote.stalker.StalkerPlaybackInfo
    ) {
