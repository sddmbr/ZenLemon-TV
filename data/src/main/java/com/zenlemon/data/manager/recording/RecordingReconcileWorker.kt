...
class RecordingReconcileWorker(
    ...
    interface RecordingWorkerEntryPoint {
        fun recordingManager(): com.zenlemon.domain.manager.RecordingManager
    }
    ...
    override suspend fun doWork(): Result {
        ...
        return when (manager.reconcileRecordingState()) {
            is com.zenlemon.domain.model.Result.Success -> Result.success()
            is com.zenlemon.domain.model.Result.Error -> Result.retry()
            com.zenlemon.domain.model.Result.Loading -> Result.retry()
        }
    }
