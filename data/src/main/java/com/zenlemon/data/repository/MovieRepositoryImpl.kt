...
import com.zenlemon.data.local.entity.MovieBrowseEntity
...
import com.zenlemon.data.sync.ContentCachePolicy
import com.zenlemon.data.sync.SyncManager
import com.zenlemon.data.util.MoviePresentationSettings
import com.zenlemon.data.util.buildPresentedMovies
import com.zenlemon.data.util.rankSearchResults
import com.zenlemon.data.util.toFtsPrefixQuery
...
import com.zenlemon.domain.model.PagedResult
...
import com.zenlemon.domain.model.Result.Success
...
class MovieRepositoryImpl @Inject constructor(
    ...
    private suspend fun loadPresentationCandidates(movie: Movie): List<com.zenlemon.data.local.entity.MovieEntity> {
    ...
    private fun com.zenlemon.data.local.entity.MovieEntity.hasFreshXtreamDetails(now: Long = System.currentTimeMillis()): Boolean {
