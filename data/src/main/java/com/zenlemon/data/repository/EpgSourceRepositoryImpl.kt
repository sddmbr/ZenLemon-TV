...
import com.zenlemon.data.epg.EpgNameNormalizer
import com.zenlemon.data.epg.EpgResolutionEngine
import com.zenlemon.data.local.DatabaseTransactionRunner
import com.zenlemon.data.local.dao.ChannelEpgMappingDao
import com.zenlemon.data.local.dao.EpgChannelDao
import com.zenlemon.data.local.dao.EpgProgrammeDao
import com.zenlemon.data.local.dao.EpgSourceDao
import com.zenlemon.data.local.dao.ProviderDao
import com.zenlemon.data.local.dao.ProviderEpgSourceDao
import com.zenlemon.data.local.entity.ChannelEpgMappingEntity
import com.zenlemon.data.local.entity.EpgChannelEntity
import com.zenlemon.data.local.entity.EpgProgrammeEntity
import com.zenlemon.data.local.entity.EpgSourceEntity
import com.zenlemon.data.local.entity.ProviderEpgSourceEntity
...
import com.zenlemon.data.util.ProviderInputSanitizer
import com.zenlemon.data.util.UrlSecurityPolicy
import com.zenlemon.data.remote.http.HttpRequestProfile
import com.zenlemon.data.remote.http.safeRequestIdentitySummary
import com.zenlemon.data.remote.http.withRequestProfile
...
import com.zenlemon.domain.model.EpgSource
import com.zenlemon.domain.model.Program
import com.zenlemon.domain.model.ProviderEpgSourceAssignment
        ...
        transactionRunner.inTransaction {
            ...
            epgSourceDao.insert(
                EpgSourceEntity(
                    ...
                    url = "zenlemon://epg-source-staging/${source.id}",
                    enabled = false,
